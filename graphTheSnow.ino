...
/***************************************************************************/
{
  ...
  String legend = "3-Hourly Snowfall amount (mm) (5 Days)";
  ...
  for (int i = 0; i < ThreeHourSamples; i++) {
    smoothedData[i * 6] = WxForecast[i].Snowfall;
  ...
  //  I do for the Snow and temp values and extrapolated the time values.
  ...
  for (int i = 0; i < (ThreeHourSamples * intermediatesCt) - 5; i++) {
    ...
    //    Serial.printf("Snow %3i is %.2f, thisY %.2f\r\n",
